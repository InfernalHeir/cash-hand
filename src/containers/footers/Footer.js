              ...
              <div className="footer__widget">
                ...
                <div className="footer__inner">
                  <ul className="ft__menu">
                    <li>
                      <a href={process.env.PUBLIC_URL + "/"}>CHND Price</a>
                    </li>
                    <li>
              ...
              <div className="footer__widget information">
                ...
                <div className="footer__inner">
                  <ul className="ft__menu">
                    ...
                    <li>
                      <a href={process.env.PUBLIC_URL + "/"}>About CashHand</a>
                    </li>
                    <li>
                      <a href={process.env.PUBLIC_URL + "/"}>Privacy Policy</a>
                    </li>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-sm-6 col-12">
              <div className="copyright__inner">
                <p>CashHand Community Copyrights © All Right Reserved</p>
              </div>
            </div>
            <div className="col-lg-6 col-sm-6 col-12">
